...
export const GoalsForm = (props) => {
    ...
    const setNewGoal = (values) => {
        setGoal(goalsDispatch, {
            ...
            goal: {
                type: values.type,
                caloricDemand: parseFloat(values.caloricDemand),
        ...
        >
            {(formikProps) => (
                <View style={styles.container}>
                    ...
                    <TextInput
                        style={[globalStyles.inputAndroid, styles.input]}
                        placeholder={formikProps.values.type === GOAL_TYPES.MAINTAIN_WEIGHT ? "Waga min" : "Waga początkowa"}
                        placeholderTextColor={'grey'}
                        keyboardType={"numeric"}
                    ...
                    <TextInput
                        style={[globalStyles.inputAndroid, styles.input]}
                        placeholder={formikProps.values.type === GOAL_TYPES.MAINTAIN_WEIGHT ? "Waga max" : "Waga końcowa"}
                        placeholderTextColor={'grey'}
                        keyboardType={"numeric"}
