...
export const HistoryView = () => {
    ...
    const [measurementsFetched, setMeasurementFetched] = useState(false);

    const [dailyProgressState,] = useDailyProgress();
    ...
    // useEffect(() => {
    //     console.log("1")
    //     fetchBodyMeasurement(measurementsDispatch, { uid: user.id, date: `15-01-2022`})
    //     console.log("X")
    //     setMeasurementFetched(true);
    // }, [])
